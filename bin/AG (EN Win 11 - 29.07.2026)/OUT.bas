...
'If l_zero_palindrom <= 0 Then s_e_polindrom = "[The sequence below is a palindrome !"
...
If (warza > 0) Then
SECVENTE_INVERSE = anuntare & vbCrLf & "Nr. Inverse sequences:[" & Val(warza) & "]" & vbCrLf & "--------------------------------------------------------------------------------------"
anuntare = Empty
Else
SECVENTE_INVERSE = "No inverse sequences found !" & vbCrLf
End If
End Function
'##############################################################################################
'##############################################################################################
...
COD_repetitii = " position:[" & start_rep & "]-" & "[" & enzima_normal & " * " & repet_x & "] " & Mid(codul_ADN, start_rep + 1, repet_x * Len(enzima_normal))
...
22:
If (warza > 0) Then
REPETITII = "Repeats in " & COD_repetitii & vbCrLf
Else
REPETITII = "No repeats found !" & vbCrLf
End If
End Function
'##############################################################################################
'##############################################################################################
