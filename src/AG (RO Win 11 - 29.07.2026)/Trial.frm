...
Begin VB.Form Trial 
   ...
   Begin VB.Label anunt_porniri 
      ...
      Caption         =   "Programul poate fi utilizat de 30 de ori"
      BeginProperty Font 
         Name            =   "Arial Narrow"
         Size            =   12
         Charset         =   0
...
Mesaj_trail.Caption = "Pentru a obtine o cheie de activare pentru programul software Applied Genetics, apasati pe acest buton !"
End Sub

Private Sub Buy_MouseLeave()
Mesaj_trail.Caption = "In cazul in care aveti CD-ul original al acestui program software, gasiti cheia de activare in interiorul carcasei. In caz contrar, puteti obtine o cheie de activare online! Daca doriti testarea programului software, apasati butonul 'Continuare' ! Programul NU este activat."
End Sub

Private Sub CmdEnter_MouseEnter()
Mesaj_trail.Caption = "Pentru a continua utilizarea programului software Applied Genetics, apasati pe acest buton !"
End Sub
...
Mesaj_trail.Caption = "Pentru a introduce cheia de activarea a programului software Applied Genetics, apasati pe acest buton !"
End Sub
...
CmdEntSerial.ToolTipText = "Pentru a introduce cheia de activare, apasati aici !"
Buy.ToolTipText = "Pentru a obtine OnLine o cheie de activare, apasati aici !"
CmdEnter.ToolTipText = "Pentru a continua testarea programului " & vbCrLf & "software in mod TRIAL, apasati aici !"
...
MsgBox "Programul a mai fost instalat pe acest PC !" & vbCrLf & " Utilizarea programului in forma TRAIL pe acest PC nu este posibila !"
End
End If
...
anunt_porniri.Caption = "Programul poate fi utilizat de " & Nr_trial & " de ori"
...
Else
'MsgBox Nr_trial & "=" & BitArray
MsgBox "Programul se inchide datorita actiunilor utilizatorului! Multumesc."
End
End If
...
anunt_porniri.Caption = "Numarul de utilizari a expirat !"
CmdEnter.Caption = "Expirat !"
CmdEnter.ToolTipForeColor = vbRed
CmdEnter.ToolTipText = "Numarul de utilizari a expirat !"
Trial_pa = True
End If
...
If Nr_trial = "" Then anunt_porniri.Caption = "Programul poate fi utilizat de 30 de ori"
    End If
