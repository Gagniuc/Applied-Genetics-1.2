...
Begin VB.Form Mai_mult 
   ...
   Begin TabDlg.SSTab op_tab 
      ...
      TabsPerRow      =   5
      TabHeight       =   520
      TabCaption(0)   =   "ENZIME DE RESTRICTIE"
      ...
      TabCaption(2)   =   "TEXT PROGRAM"
      TabPicture(2)   =   "Mai_mult.frx":0038
      Tab(2).ControlEnabled=   0   'False
      Tab(2).Control(0)=   "Mostra_text"
      Tab(2).Control(1)=   "Frame1"
      Tab(2).Control(2)=   "font_marime"
      Tab(2).Control(3)=   "font_marime_real"
      Tab(2).Control(4)=   "font_tip"
      Tab(2).Control(5)=   "Frame2"
      Tab(2).Control(6)=   "Picture2"
      Tab(2).Control(7)=   "bg_txt2"
      Tab(2).Control(8)=   "Tabel_culori_font"
      Tab(2).Control(9)=   "bg_txt1"
      Tab(2).Control(10)=   "Ferestre_plat_forma"
      Tab(2).ControlCount=   11
      TabCaption(3)   =   "CODONI"
      TabPicture(3)   =   "Mai_mult.frx":0054
      Tab(3).ControlEnabled=   0   'False
      Tab(3).Control(0)=   "codoni_explicatii_formal"
      Tab(3).Control(1)=   "CODAMINIFORMA"
      Tab(3).ControlCount=   2
      TabCaption(4)   =   "PRIMERI"
      TabPicture(4)   =   "Mai_mult.frx":0070
      Tab(4).ControlEnabled=   0   'False
      Tab(4).Control(0)=   "primer_formal"
      Tab(4).ControlCount=   1
      Begin VB.Frame primer_formal 
         Caption         =   "FORMULA PRIMERI"
         Height          =   5055
         Left            =   -74880
         TabIndex        =   128
         Top             =   600
         ...
         Begin VB.Frame Primer_platforma 
            ...
            Begin VB.Label Label7 
               ...
               Caption         =   " Aici puteti modifica formula de calcul pentru secventele primer."
               Height          =   1695
               Left            =   120
               TabIndex        =   134
               Top             =   360
         ...
         Begin VB.Frame alege_calcul_TM 
            ...
            Begin VB.Label afisare_formula_recomandata_ADN 
               Caption         =   "n => Numarul total de nucleotide selectate."
               Height          =   255
               Index           =   8
               Left            =   240
               TabIndex        =   157
            ...
            End
            Begin VB.Label afisare_formula_recomandata_ADN 
               Caption         =   "[Na+] => concentratia molara  Na+"
               Height          =   255
               Index           =   7
               Left            =   240
               TabIndex        =   156
      ...
      Begin VB.Frame codoni_explicatii_formal 
         ...
         Begin VB.Label codoni_explicatii 
            BackStyle       =   0  'Transparent
            Caption         =   "Aici puteti modifica codonii asociati anumitor aminoacizi cat si tipul notatiei aminoacizilor rezultati in urma procesarii."
            Height          =   255
            Left            =   120
            TabIndex        =   126
            Top             =   240
      ...
      Begin VB.Frame CODAMINIFORMA 
         ...
         Begin VB.CheckBox Notatie_amino 
            Caption         =   "Notatie scurta. Ex:[M,P,Q]"
            Height          =   255
            Left            =   360
            TabIndex        =   127
            Top             =   4200
      ...
      Begin VB.Frame Frame6 
         ...
         Begin VB.Label total_enz 
            Alignment       =   2  'Center
            Caption         =   "Total enzime de restrictie: 0"
            Height          =   255
            Left            =   120
            TabIndex        =   69
            Top             =   360
      ...
      Begin VB.Frame Frame4 
         ...
         Begin VB.Label R_cul_grafic 
            Alignment       =   2  'Center
            BackColor       =   &H00404040&
            Caption         =   "Culoare linie verticala."
            BeginProperty Font 
               Name            =   "Arial"
               Size            =   8.25
               Charset         =   238
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.Label Label2 
            Alignment       =   2  'Center
            BackStyle       =   0  'Transparent
            Caption         =   "Aici puteti modifica tipul, marimea si culoarea textului, cat si culoarea fundalului pentru ambele ferestre, "
            Height          =   975
            Left            =   240
            TabIndex        =   75
            Top             =   1320
      ...
      Begin VB.Frame exp_enzimeq 
         ...
         Begin VB.Label Label4 
            BackStyle       =   0  'Transparent
            Caption         =   "Pentru stergerea unei anumite enzime de restrictie din lista se apasa cu mouse-ul pe randul de interes si se apasa butonul 'Del'"
            Height          =   975
            Left            =   120
            TabIndex        =   77
            Top             =   1320
         ...
         Begin VB.Label exp_enzime 
            BackStyle       =   0  'Transparent
            Caption         =   "In aceasta sectiune puteti testa diferite enzime de restrictie apasand DbClick pe lista din dreapta."
            Height          =   855
            Left            =   120
            TabIndex        =   73
            Top             =   360
      ...
      Begin VB.Frame Expl_culori 
         ...
         Begin VB.Label Label1 
            BackStyle       =   0  'Transparent
            Caption         =   "Pentru modificarea culorilor apasati pe unul din segmentele din stanga apoi apasati pe casuta de culori. "
            Height          =   735
            Left            =   240
            TabIndex        =   74
            Top             =   360
...
End If
mod_codoni_formal.Caption = "Modificare codoni pentru " & amino_buton(Index).Caption
...
total_enz.Caption = "Total enzime de restrictie: " & i
i = 0
...
MsgBox "Nu folositi caracterul ',' la inceputul sau la sfarsitul sirului de codoni !"
Exit Sub
End If
    Dim A As Variant
    Dim i As Integer
...
zat = A(i)
If Len(zat) > 3 Then
MsgBox "Codonii nu pot depasi 3 nucleotide !"
Exit Sub
End If

If Len(zat) < 3 Then
MsgBox "Codonii nu pot fi mAi mici de trei nucleotide !"
Exit Sub
End If
'-------------------------------------------------------------------------------]
For w = 1 To Len(A(i))
...
Else
If genue = "t" Then
MsgBox "Timina este componenta ADN, inlocuiti 't' cu 'u' !"
Else
MsgBox "Sunt acceptate doar caracterele: a/c/g/u/"
End If
Exit Sub
End If
Next w
...
Else
Notatie_amino.Caption = "Notatie lunga. Ex:[Met,Pro,Gln]"
...
If opi >= 2 Then
MsgBox "Caracterul '*' reprezinta punctul de clivare al enzimei de restrictie" & vbCrLf & " si poate fi scris o singura data !"
Exit Sub
End If
Next i
...
Else
MsgBox "Sunt acceptate doar caracterele: a/c/g/t/u/*/"
Exit Sub
End If
Next i
'----------------------------------------------------
...
MsgBox "Nu pot exista in baza de date doua enzime cu acelasi nume !"
Close #wy
Exit Sub
End If

If cod_e.Text = cod_en Then
MsgBox "Nu pot exista doua secvente identice in baza de date !"
Close #wy
Exit Sub
End If
...
'tmpo = MsgBox("Doriti stergerea acestei enzime ?", vbYesNo, "Applied Genetics - beta")
...
total_enz.Caption = "Total enzime de restrictie: " & i - 1
Kill (App.Path & "\AG_DB.db")
Call FileCopy(App.Path & "\AG_BD.tmp", App.Path & "\AG_DB.db")
