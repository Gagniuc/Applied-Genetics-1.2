...
'############
If Mai_mult.enzime_de_test.ListCount = 0 Then MsgBox "Nu au fost aleasa nici o enzima de restrictie din lista ! " & vbCrLf & " Apasati butonul " & Chr(34) & "ENZIME" & Chr(34)
...
22:
If (warza > 0) Then
enz_normal_dreapta = "Nr. situsuri de restrictie existente deja in directia 5'-3':[" & warza & "]" & vbCrLf
Else
enz_normal_dreapta = "In directia 5'-3' nu exista situsuri de restrictie !" & vbCrLf
End If
End Function
'##############################################################################################
'##############################################################################################
...
22:
If (warza > 0) Then
enz_normal_stanga = "Nr. situsuri de restrictie existente deja in directia 3'-5':[" & warza & "]" & vbCrLf
Else
enz_normal_stanga = "In directia 3'-5' nu exista situsuri de restrictie !" & vbCrLf
End If
End Function
'##############################################################################################
'##############################################################################################
...
out_put_x = out_put_x & "[" & ce_enzima & "] Situsuri de r. POSIBILE prin DELETIA a " & Dist & " nucleotide 5'-3': [" & situsuri_restrictie_del & "]" & out & vbCrLf & vbCrLf
Else
'out_put_x = out_put_x & "In directia 5'-3' prin DELETIA a " & Dist & " nucleotide NU exista situsuri de r. POSIBILE!" & vbCrLf
End If
...
out_put_x = out_put_x & "[" & ce_enzima & "] Situsuri de r. POSIBILE prin DELETIA a " & Dist & " nucleotide 3'-5': [" & situsuri_restrictie_del_inv & "]" & out & vbCrLf & vbCrLf
Else
'out_put_x = out_put_x & "In directia 3'-5' prin DELETIA a " & Dist & " nucleotide NU exista situsuri de r. POSIBILE!" & vbCrLf
End If
...
out_put_x = out_put_x & "[" & ce_enzima & "] Situsuri de r. POSIBILE prin INSERTIA a " & Dist & " nucleotide 5'-3': [" & situsuri_restrictie_ins & "]" & out & vbCrLf & vbCrLf
Else
'out_put_x = out_put_x & "In directia 5'-3' prin DELETIA a " & Dist & " nucleotide NU exista situsuri de r. POSIBILE!" & vbCrLf
End If
...
If (situsuri_restrictie_ins > 0) Then
out_put_x = out_put_x & "[" & ce_enzima & "] Situsuri de r. POSIBILE prin INSERTIA a " & Dist & " nucleotide 3'-5': [" & situsuri_restrictie_ins & "]" & out & vbCrLf & vbCrLf
Else
'out_put_x = out_put_x & "In directia 5'-3' prin DELETIA a " & Dist & " nucleotide NU exista situsuri de r. POSIBILE!" & vbCrLf
End If
...
SC_out_put (" Fragmentul restrictat incepe de la pozitia: [" & old_intaietate_are + 1 - rev1 & "]")

secventa_restrictata = Mid$(cod, old_intaietate_are + 1 - rev1, (intaietate_are - old_intaietate_are) - rev2 + rev1)
secvente_rerstrictate(i) = secventa_restrictata
Ordine_ambii_algoritmi(i) = intaietate_are + 1 - rev1

SC_out_put (vbCrLf & distantier_linii & vbCrLf & secventa_restrictata & vbCrLf & distantier_linii & vbCrLf & "-- Fragmentul de restrictie are: [" & Len(secventa_restrictata) & "b] -- " & Proportie_A_T_G_C_U(secventa_restrictata, True) & vbCrLf & distantier_linii & vbCrLf & vbCrLf)
1:
Next i

SC_out_put (vbCrLf & distantier_linii & vbCrLf & _
"Total situsuri de restrictie existente in directiile 5'-3' si 3'-5':[" & situsuri_restrictie_del_d + situsuri_restrictie_del_s & "]" & vbCrLf & _
...
MsgBox "Enzima este mai mare decat codul de analizat !"
