...
Begin VB.Form Principal 
   ...
   Begin AG.jcFrames Proprietati_stanga 
      ...
      Begin TabDlg.SSTab Tab_proprietati 
         ...
         Tab(0).Control(0)=   "Arata_fragmente"
         Tab(0).Control(1)=   "distanta_DEL"
         Tab(0).Control(2)=   "enzima"
         Tab(0).Control(3)=   "distanta_n"
         Tab(0).Control(4)=   "distanta_x"
         Tab(0).Control(5)=   "Incepand_distanta_DEL"
         Tab(0).Control(6)=   "del_dreapta"
         Tab(0).Control(7)=   "del_stanga"
         Tab(0).Control(8)=   "normal_stanga"
         Tab(0).Control(9)=   "normal_dreapta"
         Tab(0).Control(10)=   "ins_stanga"
         Tab(0).Control(11)=   "ins_dreapta"
         Tab(0).Control(12)=   "optiuni_proprietati_arata"
         Tab(0).Control(13)=   "bara_date2"
         Tab(0).Control(14)=   "dista"
         Tab(0).Control(15)=   "d_n"
         Tab(0).Control(16)=   "d_x"
         Tab(0).Control(17)=   "de_la_distanta"
