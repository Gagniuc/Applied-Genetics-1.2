...
Begin VB.Form Principal 
      ...
      Begin TabDlg.SSTab Tab_proprietati 
         ...
         Begin VB.Frame Delimitare_platforma 
            ...
            Begin VB.CheckBox Delimitator_AUG 
               ...
               Left            =   120
               TabIndex        =   131
               ToolTipText     =   "Delimit start signal OutPut"
               Top             =   360
               Width           =   1575
            End
         ...
         Begin VB.Frame Notatii_platforma 
            ...
            Begin VB.Label Info_casuta 
               Caption         =   "The word ""POSITION""  locates the start or stop codons in the given sequence."
               BeginProperty Font 
                  Name            =   "Arial"
                  Size            =   8.25
                  Charset         =   238
         ...
         Begin VB.Frame Bruta_optiuni 
            ...
            Begin VB.CheckBox SI_grafic_step_by_step 
               Caption         =   "Show I.S. in graphic format"
               Height          =   195
               Left            =   120
               TabIndex        =   164
               Top             =   2280
            ...
            Begin VB.CheckBox arata_SI 
               Caption         =   "Show fragments in plain text"
               Height          =   195
               Left            =   120
               TabIndex        =   119
               Top             =   2040
            ...
            Begin VB.Label Label2 
               AutoSize        =   -1  'True
               Caption         =   "Target combination 255 characters:"
               BeginProperty Font 
                  Name            =   "Tahoma"
                  Size            =   8.25
                  Charset         =   0
         ...
         Begin VB.CheckBox Arata_fragmente 
            Caption         =   "Show restriction fragments"
            Height          =   195
            Left            =   360
            TabIndex        =   61
            Top             =   4200
   ...
   Begin AG.jcFrames Editare_mijloc 
      ...
      Begin VB.PictureBox segment_total_gena 
         ...
         Begin VB.Label anunt_schimbare_fundal 
            BackStyle       =   0  'Transparent
            Caption         =   "Please wait, changing background ..."
            BeginProperty Font 
               Name            =   "Lucida Console"
               Size            =   24
               Charset         =   0
   ...
   Begin AG.jcFrames Anunt_jos 
      ...
      Begin VB.Label mesagerie_statica 
         BackColor       =   &H00C0C0C0&
         BackStyle       =   0  'Transparent
         Caption         =   "Selected from nucleotide"
         ForeColor       =   &H00000000&
         Height          =   255
         Index           =   0
         Left            =   120
      ...
      Begin VB.Label mesagerie_statica 
         BackColor       =   &H00C0C0C0&
         BackStyle       =   0  'Transparent
         Caption         =   "Total nucleotides selected:"
         ForeColor       =   &H00000000&
         Height          =   255
         Index           =   2
         Left            =   5040
...
If (d = "u") Then MsgBox "The selected sequence is RNA !": Exit Sub
...
MsgBox "The limit is 255 bases !", vbApplicationModal + vbCritical, "Attention !"
Exit Sub
End If
...
Else
MsgBox "The file structure is corrupted !" '& vbCrLf & "Programul continua sa importeze continutul fisierului ca atare !"
Exit Sub
End If


Else
MsgBox "The file does not contain the GeneBank format !" '& vbCrLf & "Programul continua sa importeze continutul fisierului ca atare !"
Exit Sub
End If
...
C_brut_start.Caption = "Start combination: " & Len(txtStartCombo.Text) & " b"
...
If Antisens.Value = True Then out_put.Text = out_put.Text & vbCrLf & bara_de_delimitare_text & vbCrLf & "The ANTISENSE strand starts at position [" & selectare_start.Caption & "] in the INPUT sequence and is:" & vbCrLf & CATENA_PLUS(COD_CODON.SelText) & vbCrLf & "pana la nucleotida [" & selectare_stop.Caption & "] from the sequence entered in INPUT. Length of the ANTISENSE strand:[" & Total_selectie.Caption & "]" & vbCrLf & bara_de_delimitare_text
If Revers.Value = True Then out_put.Text = out_put.Text & vbCrLf & bara_de_delimitare_text & vbCrLf & "The REVERSED sequence comes from the INPUT sequence - from nucleotide [" & selectare_start.Caption & "]:" & vbCrLf & REVERSUL(COD_CODON.SelText) & vbCrLf & "pana la nucleotida [" & selectare_stop.Caption & "] from the sequence entered in INPUT. Length of the REVERSED strand:[" & Total_selectie.Caption & "]" & vbCrLf & bara_de_delimitare_text
If ARN_la_ADN.Value = True Then out_put.Text = out_put.Text & vbCrLf & bara_de_delimitare_text & vbCrLf & "[RNA to DNA] the DNA sequence starts at [" & selectare_start.Caption & "]:" & vbCrLf & ARN_ADN_f(COD_CODON.SelText) & vbCrLf & "pana la nucleotida [" & selectare_stop.Caption & "] from the sequence entered in INPUT. Length of the DNA strand:[" & Total_selectie.Caption & "]" & vbCrLf & bara_de_delimitare_text
If ADN_la_ARN.Value = True Then out_put.Text = out_put.Text & vbCrLf & bara_de_delimitare_text & vbCrLf & "[DNA to RNA] the RNA sequence starts at [" & selectare_start.Caption & "]:" & vbCrLf & ADN_ARN_f(COD_CODON.SelText) & vbCrLf & "pana la nucleotida [" & selectare_stop.Caption & "] from the sequence entered in INPUT. Length of the RNA strand:[" & Total_selectie.Caption & "]" & vbCrLf & bara_de_delimitare_text
...
If Adn_prot.Value = True Then out_put.Text = out_put.Text & vbCrLf & bara_de_delimitare_text & vbCrLf & "[DNA to PROTEIN] the DNA sequence starts at [" & selectare_start.Caption & "] pana la nucleotida [" & selectare_stop.Caption & "] from the sequence entered in INPUT." & vbCrLf & "Lungimea lantului de aminoacizi:[" & nr_aa & " aa]" & vbCrLf & "The sequence is: " & vbCrLf & "[" & str_aa & "]" & vbCrLf
...
gel_enzima.Caption = "Enzyme: " & Split(Lista_cu_geluri.Gel_nr_X(R).ToolTipText, "@")(1)
...
SC_out_put (vbCrLf & vbCrLf & "Fragment no. [" & fragmentul_nr_x & "] - lungime: [" & _
...
distanta_pe_GEL.Caption = "Migration : " & y_real & "b - " & Y & "mm"
...
tmpo = MsgBox("Do you want to exit the program without saving the project ?", vbYesNo, "Applied Genetics")
If tmpo = 7 Then
...
d_n.Caption = "Distance " & dista.Caption & "b ... " & de_la_distanta.Caption & "b"
Else
d_n.Caption = "Distance " & de_la_distanta.Caption & "b ... " & dista.Caption & "b"
End If

d_x.Caption = "Distance " & dista.Caption & "b"
...
MsgBox "The program has not finished processing the data !"
Exit Sub
End If

Printare.Caption = "Processing ..."
    Dim Fifi As Integer
    Fifi = FreeFile
...
ea2 = "<a alt='Total sequence length: " & (Len(ea2) * 2) + ea3 & "b' " & _
...
dh2 = dh2 & "<td><Center><font color='" & DectoWebCol(out_put.ForeColor) & "'>Gel nr:[" & i & "]<br> Contine [" & e1 & "] fragments.<br> Enzyme: [" & e2 & "]</font></center></td>"
...
Ce_E.Caption = "Probe = " & Total_selectie.Caption & "b"
End If
...
procent_GC.Caption = "G+C percentage = " & GC_la_suta & "%"
...
Mai_mult.Notatie_amino.Caption = "Long notation. Ex:[Met,Pro,Gln]"
End If
End If
'-------------------------------------------------------|
...
da_nu_bruiaj = "Found " & b & " characters that are not part of the genetic code."
out_put.Text = da_nu_bruiaj & vbCrLf & "Filtered sequence[" & n & " b]:" & vbCrLf & out_put.Text & j & vbCrLf
Else
da_nu_bruiaj = "No characters improper to the genetic code were found."
...
Exit Sub
SaveCodeError:
MsgBox "Please check the path to the file !", , ""
End Sub
...
If Tab_proprietati.Tab = 2 Then
    If Len(assas) > Val(txtEndLen) - 1 Then
        ...
        MsgBox "Processing complete !", vbApplicationModal + vbInformation, "Inverse sequences !"
...
If Tab_proprietati.Tab = 3 Then
    If Len(assas) > Val(r_la.Text) - 1 Then
        cBrute.ForceCombinationCalc
        MsgBox "Processing complete !", vbApplicationModal + vbInformation, "REPEATED sequences !"
        Testeaza_CODUL_Click
    End If
